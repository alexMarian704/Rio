...
public class ListRemoveLastCommand extends AbstractCommand {

    private static final String NAME = "RPOP";

    public ListRemoveLastCommand(KeyValueStore keyValueStore) {
    ...
    public String handle(List<String> data) {
        ...
        String value;
        try {
            value = keyValueStore.pollLast(key);
